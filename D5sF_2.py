...
def import_sd():
    ...
    return StableDiffusionPipeline, DDIMScheduler, BrightnessScorer, CompressibilityScorer, CLIPScorer, ImageRewardScorer, HPSScorer
...
def main():
    ...
    for curr_scorer in scorers:
        for method in methods:
            if True:
                StableDiffusionPipeline, DDIMScheduler, BrightnessScorer, CompressibilityScorer, CLIPScorer, ImageRewardScorer, HPSScorer = import_sd()
