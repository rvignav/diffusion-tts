...
def main():
    ...
    methods = ['zero_order', 'eps_greedy']     #['beam', 'mcts', 'zero_order', 'eps_greedy']
    N = 4
    lambda_param = 0.15
    eps = 0.4
    K = 20
    ...
    for curr_scorer, method in tasks:
        ...
        with open(output_dir / f'{script_name}_{backend}_{curr_scorer}_{method}_steps{num_inference_steps}_prompts{len(prompts)}.txt', 'w') as f:
